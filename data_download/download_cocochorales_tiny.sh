...
# DOWNLOAD ONLY THE TINIEST AMOUNT, THIS IS ALREADY 5 GB COMPRESSED!!!
mkdir main_dataset
wget https://storage.googleapis.com/magentadata/datasets/cocochorales/cocochorales_full_v1_zipped/main_dataset/train/1.tar.bz2 -P main_dataset
